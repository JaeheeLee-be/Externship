...
class TestInitialService(IsolatedRedisTestClient):
    ...
    @patch("apps.qna.chatbot.clients.groq.requests.post")
    def test_create_initial_answer_timeout(self, mock):
    ...
    @patch("apps.qna.chatbot.clients.groq.requests.post")
    def test_create_initial_answer_api_error(self, mock):
        mock.side_effect = GroqAPIError
        with self.assertRaises(ExternalAPIException):
            InitialService._create_initial_answer(self.question, self.category)

    @patch("apps.qna.chatbot.clients.groq.requests.post")
    def test_save_initial_answer_success(self, mock):
        mock.return_value = self.res
    ...
    @patch("apps.qna.chatbot.clients.groq.requests.post")
    def test_save_initial_answer_raise_409(self, mock):
        mock.return_value = self.res
    ...
    @patch("apps.qna.chatbot.clients.groq.requests.post")
    def test_save_initial_answer_raise_404(self, mock):
        mock.return_value = self.res
    ...
    @patch("apps.qna.chatbot.clients.groq.requests.post")
    def test_save_initial_answer_save_data_equal_cached_data(self, mock):
        mock.return_value = self.res
    ...
    @patch("apps.qna.chatbot.clients.groq.requests.post")
    def test_save_initial_answer_for_created(self, mock):
        mock.return_value = self.res
    ...
    @patch("apps.qna.chatbot.clients.groq.requests.post")
    def test_get_initial_answer_returns_cached(self, mock):
        mock.return_value = self.res
        InitialService.save_initial_answer(self.question.id)
    ...
    @patch("apps.qna.chatbot.clients.groq.requests.post")
    def test_get_initial_answer_raise_conflict(self, mock_post, mock_lock):
    ...
    @patch("apps.qna.chatbot.clients.groq.requests.post")
    def test_get_initial_answer_saves_and_returns(self, mock):
        mock.return_value = self.res
        result = InitialService.get_initial_answer(self.question.id)
