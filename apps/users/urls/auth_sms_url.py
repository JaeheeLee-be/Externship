...
urlpatterns = [
    ...
    path("accounts/verification/send-sms", SmsSendView.as_view(), name="send-sms"),
    # 최종 경로: api/v1/accounts/verification/verify-sms
    path("accounts/verification/verify-sms", SmsVerificationView.as_view(), name="verify-sms"),
