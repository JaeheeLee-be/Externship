...
from apps.users.serializers import AdminAccountQuerySerializer, AdminAccountSerializer
from apps.users.services import AdminAccountService
        ...
        return Response(
            {
                ...
                "previous": f"{base_url}?page={page - 1}&page_size={page_size}"
                if page > 1
                else None,
